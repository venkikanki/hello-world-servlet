...
// for display purposes
      ...
      git 'https://github.com/venkikanki/hello-world-servlet.git'
...
post {
        success {
            mail to:"bonavenkateswarareddy1@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"bonavenkateswarareddy1@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
